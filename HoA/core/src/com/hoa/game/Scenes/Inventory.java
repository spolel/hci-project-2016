       ...
       viewport = new FitViewport(HoA.screenWidth, HoA.screenHeight, new OrthographicCamera());
        ...
        switch (game.level){
            ...
            case 5: weaponbutton =  new SpriteDrawable(new Sprite(new Texture("Items/diamondflail.png")));
                shieldbutton =  new SpriteDrawable(new Sprite(new Texture("Items/heathershield.png")));
            ...
            case 6: weaponbutton =  new SpriteDrawable(new Sprite(new Texture("Items/diamondspear.png")));
                shieldbutton =  new SpriteDrawable(new Sprite(new Texture("Items/heathershield.png")));
                weaponlabel = new Label("Weapon:                Diamond Spear", new Label.LabelStyle(new BitmapFont(), Color.RED));
                shieldlabel = new Label("Shield:                   Iron Shield", new Label.LabelStyle(new BitmapFont(), Color.RED));
                break;
            case 7: weaponbutton =  new SpriteDrawable(new Sprite(new Texture("Items/obisdiansword.png")));
                shieldbutton =  new SpriteDrawable(new Sprite(new Texture("Items/heathershield.png")));
            ...
            case 8: weaponbutton =  new SpriteDrawable(new Sprite(new Texture("Items/obsidianflail.png")));
                shieldbutton =  new SpriteDrawable(new Sprite(new Texture("Items/heathershield.png")));
                weaponlabel = new Label("Weapon:                Obsidian Flail", new Label.LabelStyle(new BitmapFont(), Color.RED));
                shieldlabel = new Label("Shield:                   Iron Shield", new Label.LabelStyle(new BitmapFont(), Color.RED));
                break;
            case 9: weaponbutton =  new SpriteDrawable(new Sprite(new Texture("Items/obisdianspear.png")));
                shieldbutton =  new SpriteDrawable(new Sprite(new Texture("Items/heathershield.png")));
                weaponlabel = new Label("Weapon:                Obsidian Spear", new Label.LabelStyle(new BitmapFont(), Color.RED));
                shieldlabel = new Label("Shield:                   Iron Shield", new Label.LabelStyle(new BitmapFont(), Color.RED));
                break;
