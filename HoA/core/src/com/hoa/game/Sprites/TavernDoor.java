 ...
 */
public class TavernDoor extends InteractiveTile {

    public TavernDoor(World world, TiledMap map, Rectangle bounds, HoA game) {
    ...
    public void onCollision() {
        ...
        super.game.setScreen(new Tavern(super.game));
    }
